...
1. Download repo from the following [address](https://github.com/linuxacademy/content-kubernetes-prometheus-env)
- Useful if traditional plugin is out of date

```
git@github.com:linuxacademy/content-kubernetes-prometheus-env.git
```

2. upload the following json file import popup in Grafana dashboard

<img src="https://user-images.githubusercontent.com/6856382/222976569-1555325e-10db-4f01-b413-aa4a715e145f.png">

**/content-kubernetes-prometheus-env/grafana/dashboard/Kubernetes All Nodes.json**
```
{
  "__inputs": [
    {
...
<img src="https://user-images.githubusercontent.com/6856382/222976632-b3a6759c-b3de-4a6d-8b2d-1f591f0fafc7.png">
